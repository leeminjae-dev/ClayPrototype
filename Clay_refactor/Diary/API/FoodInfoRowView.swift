...
struct FoodInfoRowView : View {
    ...
    var body: some View {
        ...
        NavigationLink(destination: NutritionAddView(items: self.$items, searchFoodName : $searchFoodName,foodSuccess: $foodSuccess,showingPopup: $showingPopup, foodName: $foodName, serveSize : $serveSize, foodKcal : $foodKcal, isSearch: $isSearch)){
            HStack{
                 VStack(spacing: 10){
                     HStack{
